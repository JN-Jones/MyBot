...
/* Admin Modul */
$l['mybot_overview'] = "&Uuml;bersicht &uuml;ber alle Regeln";
$l['mybot_addrule'] = "Neue Regel hinzuf&uuml;gen";
$l['mybot_addrule_desc'] = "Hier kannst du eine neue Regel hinzuf&uuml;gen";
...
$l['mybot_username_desc'] = "Wie soll der neue Benutzer hei&szlig;en?";
$l['mybot_username_not'] = "Kein Benutzername angegeben";
$l['mybot_pw'] = "Passwort";
$l['mybot_pw_desc'] = "Bitte gebe ein Passwort f&uuml;r den neuen Benutzer an";
$l['mybot_pw_not'] = "Kein Passwort angegeben";
$l['mybot_email'] = "E-Mail";
$l['mybot_email_desc'] = "Bitte gebe die E-Mail f&uuml;r den neuen Benutzer an";
$l['mybot_email_not'] = "Keine E-Mail angegeben";
$l['mybot_group'] = "Gruppe";
$l['mybot_group_desc'] = "Welcher Gruppe soll der neue Benutzer angeh&ouml;ren?";
$l['mybot_group_not'] = "Interner Fehler [2]";
$l['mybot_groupname'] = "Gruppenname";
$l['mybot_groupname_desc'] = "Wie soll die neue Gruppe hei&szlig;en?";
$l['mybot_groupname_not'] = "Kein Gruppenname angegeben";
$l['mybot_save'] = "Speichern";
$l['mybot_installed_group'] = "{1}<br />User \"{2}\" und Gruppe \"{3}\" neu hinzugef&uuml;gt<br />Bitte bearbeite diese noch einmal zur Sicherheit";
$l['mybot_installed_user'] = "{1}<br />User \"{2}\" neu hinzugef&uuml;gt<br />Bitte bearbeite diesen noch einmal zur Sicherheit";
